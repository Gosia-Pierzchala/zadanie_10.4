public class PamiecRam extends Komponent {
    private int pamiecMB;
    private int taktowanieMHz;
    private double tempPrzyTaktowaniu;
    private double maxTemp;

    public PamiecRam(String nazwaModelu, String producent, String numerSeryjny, int pamiecMB, int taktowanieMHz, double tempPrzyTaktowaniu, double maxTemp) {
        super(nazwaModelu, producent, numerSeryjny);
        this.pamiecMB = pamiecMB;
        this.taktowanieMHz = taktowanieMHz;
        this.tempPrzyTaktowaniu = tempPrzyTaktowaniu;
        this.maxTemp = maxTemp;
    }

    public int getPamiecMB() {
        return pamiecMB;
    }

    public void setPamiecMB(int pamiecMB) {
        this.pamiecMB = pamiecMB;
    }
